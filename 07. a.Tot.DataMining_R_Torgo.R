...
hist(algae$mxPH, prob=T,col='pink')
...
abline(h=mean(algae$NH4,na.rm=T)+sd(algae$NH4,na.rm=T),lty=2,lwd=2,col='blue')
abline(h=median(algae$NH4,na.rm=T),lty=3,lwd=2,col='red')
identify(algae$NH4)
